...
public class SubMenu {
	...
	public void update() {
		...
		while (subMenuNumber != 0) {
			...
			System.out.println("|                [ 2 ] para Destino                               |");
			System.out.println("|                [ 3 ] para Hospedagem                            |");
			System.out.println("|                [ 4 ] para Contato                               |");
			System.out.println("|                [ 0 ] para Voltar ao menu anterior               |");
			System.out.println("|  ## OBS: Viagem não pode ser alterado, caso tenha realizado a   |");
			System.out.println("|         viagem errada delete a anterior e crie uma nova         |");
			System.out.println("|_________________________________________________________________|");
			subMenuNumber = inputNumber.nextInt();
			switch (subMenuNumber) {
			case 0: {
			...
			case 5: {
				...
				System.out.println("Digite o campo que deseja fazer a alteração");
				System.out.println(
						"Campo disponiveis, obsevacoes, desconto,dataSaida,dataEntrada,id_destino, id_usuario");
				String campo = inputStr.nextLine();
				switch (campo) {
				case "observacoes": {
				...
				case "id_destino":{
					destinoDao.readDestino();
					System.out.println("Escolha o id para alteração");
					destino.setId_destino(inputNumber.nextInt());
					viagem.setDestino(destino);
					viagemDao.updateViagem(viagem, id, campo);
					break;
				...
				case "possuiHospedagem":{
					System.out.println("Se possui viagem digite 1 senão digite 0");
					viagem.setPossuiHospedagem(inputNumber.nextInt());
				}
